...
namespace RustyWires
{
    ...
    public class RustyWiresViewModelProvider : ViewModelProvider
    {
        public RustyWiresViewModelProvider()
        {
            ...
            AddSupportedModel<LockTunnel>(t => new RustyWiresFlatSequenceSimpleBorderNodeViewModel(t, @"Resources\Diagram\Nodes\Lock.png"));
            AddSupportedModel<FlatSequenceTerminateLifetimeTunnel>(t => new RustyWiresFlatSequenceSimpleBorderNodeViewModel(t, @"Resources\Diagram\Nodes\TerminateLifetime.png"));
            AddSupportedModel<RustyWiresFlatSequenceSimpleTunnel>(t => new FlatSequenceTunnelViewModel(t));
            AddSupportedModel<UnwrapOptionTunnel>(t => new RustyWiresFlatSequenceSimpleBorderNodeViewModel(t, @"Resources\Diagram\Nodes\UnwrapOption.png"));
