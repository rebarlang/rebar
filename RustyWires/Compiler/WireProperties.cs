...
namespace RustyWires.Compiler
{
    internal static class WireProperties
    {
        ...
        /// </summary>
        private static readonly AttributeDescriptor _isFirstVariableWireTokenName = new AttributeDescriptor("RustyWires.Compiler.IsFirstVariableWire", true);
        ...
        /// <see cref="Variable"/>.
        /// </summary>
        private static readonly AttributeDescriptor _wireBeginsMutableVariableTokenName = new AttributeDescriptor("RustyWires.Compiler.WireBeginsMutableVariable", true);
