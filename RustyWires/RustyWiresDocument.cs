...
namespace RustyWires
{
    ...
    [ExportDocumentAndFileType(
        ...
        modelDefinitionType: RustyWiresFunction.RustyWiresFunctionDefinitionType,
        ...
        defaultFileNameType: typeof(RustyWiresDocumentType))]
    [AllowableAsTypeMember(true)]
    public class RustyWiresDocumentType : SourceFileDocumentType
    {
        /// <summary>
        /// Our command line
        /// </summary>
        public const string OpenArgument = "openRustyWires";
        ...
        {
            return Host.CreateInstance<RustyWiresDocument>();
        }
    }
    ...
    public class RustyWiresDocument : SourceFileDocument, IProvideOverlayHelp
    {
        private static readonly string _rustyWiresDocumentUniqueIdPrefix = "RustyWiresDocument:";
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "DocumentCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ElementCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "SelectionCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "DiagnosticsTabCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "DiagnosticsCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "DynamicPaneCommand",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "DocumentTool",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ContextMenuCommand",
        ...
        {
            yield return new RustyWiresDiagramEditorInfo(RustyWiresDiagramEditor.UniqueId, this);
        ...
        {
            var document = s.ActiveDocument as RustyWiresDocument;
            document.OnlyShowSketchDiagramEditor = !document.OnlyShowSketchDiagramEditor;
        })
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ShowHideEditorsCommand",
        ...
        {
            ((RustyWiresDocument)s.ActiveDocument).ShowOrFocusModelessWindow();
        })
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ShowModelessDialogCommand",
    ...
    /// <summary>
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ToggleHeader",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ToggleDone",
        ...
        {
            UniqueId = _rustyWiresDocumentUniqueIdPrefix + "ChangeText",
            LabelTitle = "Text",
        ...
        {
            var document = (RustyWiresDocument)site.ActiveDocument;
        ...
        /// </summary>
        public const string OverlayHelpTitle = "RustyWires Function";

        /// <summary>
        /// Our identifier
        /// </summary>
        public const string Identifier = "RustyWiresDocument";

        /// <summary>
        /// Title for document right rail.
        /// </summary>
        public const string ConfigurationPaneTitle = "RustyWires Function";
