...
namespace Tests.Rebar.Unit.Execution
{
    ...
    public class LoopExecutionTests : ExecutionTestBase
    {
        ...
        public void LoopWithOutputTunnelThatDoesNotExecute_Execute_TunnelOutputsNoneValue()
        {
            ...
            Constant falseConstant = ConnectConstantToInputTerminal(conditionTunnel.InputTerminals[0], PFTypes.Boolean, false);
            falseConstant.Value = false;
        ...
        public void LoopWithOutputTunnelThatExecutes_Execute_TunnelOutputsSomeValue()
        {
            ...
            Loop loop = new Loop(function.BlockDiagram);
            LoopConditionTunnel conditionTunnel = CreateLoopConditionTunnel(loop);
            Constant trueConstant = ConnectConstantToInputTerminal(conditionTunnel.InputTerminals[0], PFTypes.Boolean, false);
            trueConstant.Value = true;
            ...
            Constant falseConstant = ConnectConstantToInputTerminal(assign.InputTerminals[1], PFTypes.Boolean, false);
            falseConstant.Value = false;
            Tunnel outputTunnel = CreateOutputTunnel(loop);
