...
namespace Rebar
{
    ...
    [ExposeFeatureToggle(typeof(RebarFeatureToggles), RebarTargetSharedLibraryInterface, CodeReadiness.Release)]
    public sealed class RebarFeatureToggles : FeatureTogglesProvider<RebarFeatureToggles>
    {
        ...
        public const string RebarTargetSharedLibraryInterface = FeaturePrefix + nameof(RebarTargetSharedLibraryInterface);
        ...
        public static bool IsRebarTargetSharedLibraryInterfaceEnabled => _rebarTargetSharedLibraryInterface.IsEnabled;
        ...
        private static readonly FeatureToggleValueCache _rebarTargetSharedLibraryInterface = CreateFeatureToggleValueCache(RebarTargetSharedLibraryInterface);
    }
}
